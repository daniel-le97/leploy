...
<template>
  <div>
    ...
    <RippleBtn class="rounded-md bg-red-500 flex gap-2 justify-center text-center align-middle" v-if="project.deployed.length">
      <Icon name="heroicons:stop-circle" class="text-xl text-center align-middle text" />
      <span class="">stop</span>
    </RippleBtn>

    <RippleBtn class="rounded-md bg-green-500 flex gap-2 justify-center text-center align-middle" @click="goToProject" v-if="project.deployed.length">
